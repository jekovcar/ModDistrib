...
<br>16.Add package updates(can, but not recommended for SPacks) to Install.wim image
<br>17.Add package updates(can, but not recommended for SPacks) to Boot.wim image
# Reference
